...
using DatoUI.VPL.Scripting.CSharp;
using DatoUI.VPL.Scripting.Python;

namespace DatoUI.VPL.Scripting.Nodes
{
    public class ScriptingNode : Node
    {
        ...
        public override void Calculate(object userState = null)
        {
            ...
            {
                case "C#":
                    if (mScriptCompiler!=null&& mScriptCompiler.IsValueCreated)
                    {
